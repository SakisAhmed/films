...
import { addItem,deleteItem } from "../JS/Actions/actions";


function Card({movie}) {
    const dispatch = useDispatch();
    const storedData = useSelector((state) => state.moviesReducers.favList);
  ...
  return <div className='card'>
      ...
      {movie.genre_ids ? (
        ...
        <div
          className="btn"
          onClick={() => {dispatch(deleteItem(movie.id));console.log(movie.id);console.log(storedData)}}
        >
